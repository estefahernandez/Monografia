...
/* Importar los datos en stata es complejo por el peso de los datos, por lo cual, son guardados inmediamente en .dta, para Limpiar y estructurar*/
        ...
        * Datos 01-Vehiculos
            ...
            import excel "$ruta/Data_master/Vehiculos-2019-2024.xlsx", sheet("BD 1") firstrow clear // Se importa 2019-2021

            compress // Guardar espacio cuando se guarde data set en el archivo

            save "$datacl/01-Vehiculos-2019-2021.dta", replace //Cuenta con observaciones de 2019 hasta 2021

        * Datos 02-Vehiculos

            import excel "$ruta/Data_master/Vehiculos-2019-2024.xlsx", sheet("BD 2") firstrow clear // Se importa 2022-2024
